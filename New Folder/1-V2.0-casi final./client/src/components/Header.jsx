      ...
      <nav className="container mx-auto px-4 py-3" aria-label="Main navigation">
        <div className="flex items-center justify-between gap-4 min-h-[60px]">
          ...
          <div className="flex items-center space-x-3 flex-shrink-0">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg bg-white/30 dark:bg-slate-800/60 hover:bg-white/50 dark:hover:bg-slate-800/80 transition-colors duration-200 backdrop-blur-sm"
        ...
        {menuOpen && (
          <div 
            ref={menuRef}
            className="lg:hidden mt-4 p-4 backdrop-blur-xl bg-white/30 dark:bg-slate-800/30 rounded-xl border border-white/20 dark:border-slate-700/30 shadow-lg animate-slideInLeft"
          >
            {/* User Info Mobile */}
            {user && (
